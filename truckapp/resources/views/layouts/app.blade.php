...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/css/ownership.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/css/modal.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('/css/partnership.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/css/index.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('/css/addprofit.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/css/profitdetail.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/css/launch.css')}}">
