      ...
      <?php echo e(csrf_field()); ?>
       ...
       <div  class="col-md-12"> 
                  <div class="row form-group col-md-10 col-md-offset-1">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="col-md-12 col-lg-12 col-sm-12 col-xs-12" name="sname" pattern="[A-Za-z ]{3,30}" placeholder="Staff Name" value="<?php echo e($editid->name); ?>" required>   
                       </div> 
                  </div> 
                  <div class="row form-group col-md-10 col-md-offset-1"> 
                      <div class="col-sm-4">
                          <input type="tel" class="col-md-12 col-lg-12 col-sm-12 col-xs-12" pattern="(09)[0-9]{9}" maxlength="11" placeholder="Phone" value="<?php echo e($editid->phone); ?>" name="scontact" required> 
                      </div> 
                       <div class="col-sm-4">
                            <input type="number" class="col-md-12 col-lg-12 col-sm-12 col-xs-12" name="sage" min="18" max="50" value="<?php echo e($editid->age); ?>" placeholder="Age" required>
                       </div>  
                      <div class="col-sm-4">  
                   ...
                   <div class="row form-group col-md-10 col-md-offset-1">
                       <div class="col-sm-4">
                          <input type="text" class="col-md-12 col-lg-12 col-sm-12 col-xs-12" name="saddr" value="<?php echo e($editid->address); ?>" placeholder="Address" required>   
                                 
                       </div> 
                       <div class="col-sm-4">
                          <input type="number" class="col-md-12 col-lg-12 col-sm-12 col-xs-12"  min="100000" max="500000" value="<?php echo e($editid->salary); ?>" placeholder="Salary" name="salary" required>
                       </div> 
                       <div class="col-sm-4">    
                        <select class="sel-tk selectpicker col-lg-12 col-md-12 col-sm-12 col-xs-12" name="degree" data-live-search="true">
                              <optgroup label="Degree">
                                <?php if($editid->degree == "Graduated"): ?>
