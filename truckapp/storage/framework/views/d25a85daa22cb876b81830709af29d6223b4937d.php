        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12"> 
              <table class="table table-hover ">
                  ...
                  <tbody>
                      <tr>
                          <th>Home</th>
                          <td><a href="<?php echo e(url('/home')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Our partnership</th>
                          <td><a href="<?php echo e(url('/partnership')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                      </tr>  
                      <tr>
                          <th>Location for trucks</th>
                          <td><a href="<?php echo e(url('/location')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Our achievements</th>
                          <td><a href="<?php echo e(url('/achieve')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                      </tr>
                      <tr>
                          <th>All Staffs Info</th>
                          <td><a href="<?php echo e(url('/staff')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Left partners</th>
                          <td><a href="<?php echo e(url('/left')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                      </tr>
                      <tr>
                          <th>Financial accounts</th>
                          <td><a href="<?php echo e(url('/account')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Net profits</th>
                          <td><a href="<?php echo e(url('/net')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                      </tr>
                      <tr>
                          <th>Add new booking</th>
                          <td><a href="<?php echo e(url('/booking')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Add new staff</th>
                          <td><a href="<?php echo e(url('/newstaff')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                      </tr>
                      <tr>
                          <th>Finish Transport</th>
                          <td><a href="<?php echo e(url('/finish')); ?>" class="btn btn-default btn-xs">Visit</a></td>
                          <th>Sleep App</th>
                          <td><a href="<?php echo e(url('/')); ?>" class="btn btn-default btn-xs">Sleep</a></td>
                      </tr>
                  </tbody>
              </table> 
        </div>
